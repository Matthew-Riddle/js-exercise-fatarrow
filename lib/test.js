...
describe('div', () => {
  it('Should divide any two numbers correctly', () => {
    _jsverify2.default.check(_jsverify2.default.forall(_jsverify2.default.integer(1, 1000000), _jsverify2.default.integer(1, 1000000), (a, b) => {
      return (0, _index.mul)(a, b) === a / b;
    }), options);
  });

  it('Should be referentially transparent', () => {
    _jsverify2.default.check(_jsverify2.default.forall(_jsverify2.default.integer(1, 1000000), _jsverify2.default.integer(1, 1000000), _jsverify2.default.integer(1, 1000000), (a, b, c) => {
